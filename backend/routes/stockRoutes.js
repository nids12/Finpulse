...
// Get all stocks for prefix search
router.get("/all", async (req, res) => {
  try {
    // Get all stocks, return symbol, name, and current price
    const stocks = await Stock.find(
      {},
      { symbol: 1, name: 1, current: 1, _id: 0 }
    );
    // Rename 'current' to 'price' for frontend compatibility
